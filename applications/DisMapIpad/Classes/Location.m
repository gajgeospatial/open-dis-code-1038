...
-(void)timerFireMethod:(NSTimer*)theTimer;
{
    ...
    if(lastLocation == nil)
    {
        NSLog(@"Unable to send own device position update--unknown own position, probably because the Apple location manager hasn't initialized yet");
        return;
    }
          ...
          fromLocation:(CLLocation *)oldLocation 
{
    ...
    NSLog(@"New position from Apple GPS=(%f, %f)", latLon.latitude, latLon.longitude);
}
